...
public class AllNewsFeedsActivity extends ListActivity {
        ...
        private static String[] results = new String[70];


        ArrayList<HashMap<String, String>> newsFeedList;

        // url to get all products list
        private String url_all_newsfeed = "https://www.test123calil.co.nf/newsfeedoutput.php";
        // JSON Node names
        ...
        public static String[] getnewsFeedArray() {
